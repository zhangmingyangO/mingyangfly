...
<script>
    ...
    $(function () {
        $("#L_nowpass").blur(function () {
            ...
            $.get({
                url:"${pageContext.request.contextPath}/user/checkNowPass/"+nowpass,
                dataType:"json",
                success:function (data) {
                    $("#span_checkNowPass").text(data.msg);
                    if( $("#span_checkNowPass").text()=="当前密码错误"){
                        $("button[class*=layui-btn]").addClass("layui-btn-disabled");
                    }
                    if($("#span_checkNowPass").text()=="当前密码正确"){
        ...
        <div class="layui-tab layui-tab-brief" lay-filter="user">
            ...
            <div class="layui-tab-content" style="padding: 20px 0;">
                <div class="layui-form layui-form-pane layui-tab-item layui-show">
                    <form method="post" action="${pageContext.request.contextPath}/user/upmessage" id="form2">
                        <div class="layui-form-item">
                            <label for="L_email" class="layui-form-label">邮箱</label>
                            <div class="layui-input-inline">
                                <input type="text" id="L_email" name="email" required lay-verify="email" autocomplete="off" value="" class="layui-input" onblur="checkEmail()">
                        ...
                        <div class="avatar-add">
                            ...
                            <c:choose>
                                <c:when test="${userinfo.picPath != ''}">
                                    <img src="${pageContext.request.contextPath}/static/uploadImgs/${userinfo.picPath}">
                                </c:when>
                                <c:otherwise>
                ...
                <div class="layui-form layui-form-pane layui-tab-item">
                    <form action="${pageContext.request.contextPath}/user/modifyPWD" method="post" >
                        <div class="layui-form-item">
                            <label for="L_nowpass" class="layui-form-label">当前密码</label>
                            <div class="layui-input-inline">
                                <input type="password" id="L_nowpass" name="nowpass" required lay-verify="required" autocomplete="off" class="layui-input" >
                                <span id="span_checkNowPass"></span>
                            </div>
                        </div>
                        <div class="layui-form-item">
